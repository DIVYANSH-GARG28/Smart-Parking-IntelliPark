/* Smart Parking System - Ultra Single-file ESP32 Backend
   - Owner + User pages embedded
   - Endpoints: /, /owner, /user, /data, /book, /user_book, /cancel, /pay, /ocr, /gate, /preview.png, /upload_preview
   - NTP sync (Asia/Kolkata)
   - IR entry/exit (debounced)
   - Gate stepper control
   - LCD status
   - Reservation logic + 30% no-show auto-cancel
   - LittleFS preview upload
*/

/*  Libraries used:
    - WiFi
    - WebServer
    - LittleFS (for preview image storage)
    - LiquidCrystal_I2C
    - Stepper
    - time
*/
